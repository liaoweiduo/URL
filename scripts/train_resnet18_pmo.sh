...
NAME="pmo"
OUTNAME="pmo-moe-sgd-ce_select-cluster_nonlinear-lr1e-2"
...
CUDA_VISIBLE_DEVICES=0 python train_net_pmo.py \
    ...
    --train.optimizer=momentum --train.learning_rate=0.01 --train.weight_decay=5e-5 \
    ...
    --train.cosine_anneal_freq=20 --train.eval_freq=20 --train.eval_size 50 # \
